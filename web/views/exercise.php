...
<body>
    ...
    <form action="add_exercise.php" method="post">
     <p>Actvity Type: <input type="text" name="activity_type"/></p>
     <p>Time Spent (minutes): <input type="number" name="time_spent"/></p>
     <p>Calories Burnt: <input type="number" name="calories"/></p>
